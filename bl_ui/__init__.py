...
def register():
    ...
    WindowManager.addon_pages = IntVectorProperty(
            name="Display page and page size",
            description="Set values for Page Navigation",
            size=3,
            min=1, max=1000,
            soft_max=100,
            default=(1, 10, 1)
            )
    WindowManager.addon_pages_enable = BoolProperty(
            name="Page Navigation",
            description="Navigate by pages instead of scrolling up and down",
            default=False
            )
    # done...
